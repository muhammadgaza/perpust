                ...
                <div class="card-body p-md-5">
                  <div class="row justify-content-center">
                    <div class="">
                      ...
                      <form action="{{route('registrasi')}}"class="mx-1 mx-md-4" method="post">
                        @csrf
                        <div class="d-flex flex-row align-items-center mb-4">
                          <i class="fas fa-user fa-lg me-3 fa-fw"></i>
                          <div class="form-outline flex-fill mb-0">
                            <input type="text" id="form3Example1c" class="form-control" name="nama" />
                            <label class="form-label" for="form3Example1c">Masukan Nama</label>
                          </div>
                        </div>
                        ...
                        <div class="d-flex flex-row align-items-center mb-4">
                          ...
                          <div class="form-outline flex-fill mb-0">
                            ...
                            <label class="form-label" for="form3Example3c">Masukan email</label>
                          </div>
                        </div>
                        ...
                        <div class="d-flex flex-row align-items-center mb-4">
                          ...
                          <div class="form-outline flex-fill mb-0">
                            <input type="text" id="form3Example4c" class="form-control"  name="alamat" />
